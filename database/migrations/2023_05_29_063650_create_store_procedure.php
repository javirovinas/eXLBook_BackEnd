    ...
    public function up(): void
    {
        $store_procedure = "
            ...
            BEGIN
                ...
                VALUES  
                ('10000', '1', 'Maintenance_Logbook', 'Completed all transit checks', 'B', '21', '0');
            END;
        ...
        DB::table('logbooks')->insert([
            ['logbook_name' => 'Maintenance_Logbook', 'trainee_id' => 1003, 'instructor_id' => 102],
            ['logbook_name' => 'Communications_Logbook', 'trainee_id' => 1000, 'instructor_id' => 101],
            ['logbook_name' => 'Physics_Logbook', 'trainee_id' => 1002, 'instructor_id' => 100],
            ['logbook_name' => 'Technologies_Logbook', 'trainee_id' => 1001, 'instructor_id' => 103],
        ]);

        DB::table('tasks')->insert([
            ['logbook_id' => 10000, 'work_order_no' => 500234, 'task_detail' => 'Completed all transit checks', 'category' => 'B', 'ATA' => '21', 'archived' => 0],
            ['logbook_id' => 10000, 'work_order_no' => 500236,'task_detail' => 'Maintenance pre-flight checks completed', 'category' => 'B', 'ATA' => '21', 'archived' => 0],
            ['logbook_id' => 10001, 'work_order_no' => 637951, 'task_detail' => 'Tested aeronautical radio systems', 'category' => 'A1', 'ATA' => '13', 'archived' => 0],
            ['logbook_id' => 10001, 'work_order_no' => 637952, 'task_detail' => 'Fixed VHF radios', 'category' => 'A1', 'ATA' => '13', 'archived' => 0],
            ['logbook_id' => 10001, 'work_order_no' => 637953, 'task_detail' => 'Evaluated range performance of communication technologies', 'category' => 'A1', 'ATA' => '13', 'archived' => 0],
            ['logbook_id' => 10002, 'work_order_no' => 712008, 'task_detail' => 'Calculated aerodynamic questions', 'category' => 'C2', 'ATA' => '07', 'archived' => 0],
            ['logbook_id' => 10002, 'work_order_no' => 712009, 'task_detail' => 'Experimented with different aircraft lifts', 'category' => 'C2', 'ATA' => '07', 'archived' => 0],
            ['logbook_id' => 10002, 'work_order_no' => 712010, 'task_detail' => 'Studied how drag affects flight', 'category' => 'C2', 'ATA' => '07', 'archived' => 0],
            ['logbook_id' => 10002, 'work_order_no' => 712011, 'task_detail' => 'Explored physics concepts involved in aviation', 'category' => 'C2', 'ATA' => '07', 'archived' => 0],
            ['logbook_id' => 10003, 'work_order_no' => 854209, 'task_detail' => 'Fixed some in-flight connectivity issues', 'category' => 'A', 'ATA' => '19', 'archived' => 0],
        ]);
    }
    /**
