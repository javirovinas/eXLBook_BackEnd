...
class TaskSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $tasks = [
            ...
            ["trainee_id" => 4, "logbook_id" => 2, "work_order_no" => 63, "task_detail" => "Tested aeronautical radio systems", "category" => "", "ATA" => ""],
            ...
            ["trainee_id" => 1, "logbook_id" => 3, "work_order_no" => 71, "task_detail" => "Calculated aerodynamics questions", "category" => "C2", "ATA" => ""],
            ...
            ["trainee_id" => 3, "logbook_id" => 4, "work_order_no" => 85, "task_detail" => "Fixed some in-flight connectivity issues", "category" => "A", "ATA" => "19"],
            ["trainee_id" => 2, "logbook_id" => 1, "work_order_no" => 87, "task_detail" => "Performed engine inspections", "category" => "B", "ATA" => "11"],
            ["trainee_id" => 2, "logbook_id" => 1, "work_order_no" => 88, "task_detail" => "Conducted aircraft fueling operations", "category" => "B", "ATA" => "3"],
