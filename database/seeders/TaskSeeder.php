...
class TaskSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $tasks = [
            ...
            ["trainee_id" => 1, "logbook_id" => 2, "work_order_no" => 63, "task_detail" => "Tested aeronautical radio systems", "category" => "C2", "ATA" => "2", "TEE_SO" => "2023-07-12 09:54:30"],
            ["trainee_id" => 1, "logbook_id" => 2, "work_order_no" => 64, "task_detail" => "Fixed VHF radios", "category" => "C2", "ATA" => "13", "TEE_SO" => "2023-07-14 18:34:14"],
            ["trainee_id" => 1, "logbook_id" => 2, "work_order_no" => 65, "task_detail" => "Evaluated range performance of communication technologies", "category" => "C2", "ATA" => "13", "TEE_SO" => "2023-07-18 11:20:31"],
            ...
            ["trainee_id" => 1, "logbook_id" => 2, "work_order_no" => 73, "task_detail" => "", "category" => "C2", "ATA" => "7"],
            ["trainee_id" => 1, "logbook_id" => 2, "work_order_no" => 74, "task_detail" => "Explored physics concepts involved in aviation", "category" => "C2", "ATA" => "7"],
            ["trainee_id" => 7, "logbook_id" => 4, "work_order_no" => 85, "task_detail" => "Fixed some in-flight connectivity issues", "category" => "", "ATA" => "19"],
            ...
            ["trainee_id" => 1, "logbook_id" => 2, "work_order_no" => 93, "task_detail" => "", "category" => "C2", "ATA" => "2"],
            ["trainee_id" => 1, "logbook_id" => 2, "work_order_no" => 94, "task_detail" => "", "category" => "C2", "ATA" => "29"],
            ["trainee_id" => 1, "logbook_id" => 2, "work_order_no" => 95, "task_detail" => "Checked aircraft navigation instruments", "category" => "", "ATA" => "22"],
            ...
            ["trainee_id" => 5, "logbook_id" => 7, "work_order_no" => 181, "task_detail" => "", "category" => "", "ATA" => "6"],
