...
class TaskSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $tasks = [
            ...
            ["trainee_id" => 7, "logbook_id" => 3, "work_order_no" => 1, "task_detail" => "Fixed some in-flight connectivity issues", "category" => "", "ATA" => "19"],
            ...
            ["trainee_id" => 7, "logbook_id" => 3, "work_order_no" => 2, "task_detail" => "Practiced aircraft emergency procedures", "category" => "C2", "ATA" => "12"],
            ["trainee_id" => 7, "logbook_id" => 3, "work_order_no" => 3, "task_detail" => "Performed weight and balance calculations", "category" => "C2", "ATA" => "5"],
            ["trainee_id" => 7, "logbook_id" => 3, "work_order_no" => 4, "task_detail" => "Conducted flight simulation sessions", "category" => "C2", "ATA" => "8"],
            ...
            ["trainee_id" => 7, "logbook_id" => 3, "work_order_no" => 5, "task_detail" => "Reviewed aircraft aerodynamics principles", "category" => "C2", "ATA" => "6"],
            ["trainee_id" => 7, "logbook_id" => 3, "work_order_no" => 6, "task_detail" => "Studied aircraft lift generation mechanisms", "category" => "C2", "ATA" => "6"],
            ["trainee_id" => 7, "logbook_id" => 3, "work_order_no" => 7, "task_detail" => "Investigated aircraft drag reduction methods", "category" => "C2", "ATA" => "6"],
            ...
            ["trainee_id" => 6, "logbook_id" => 6, "work_order_no" => 1, "task_detail" => "Reviewed aircraft navigation principles", "category" => "A1", "ATA" => "22"],
            ["trainee_id" => 6, "logbook_id" => 6, "work_order_no" => 2, "task_detail" => "Practiced using aircraft navigation instruments", "category" => "A1", "ATA" => "22"],
            ["trainee_id" => 6, "logbook_id" => 6, "work_order_no" => 3, "task_detail" => "Explored aircraft flight planning procedures", "category" => "A1", "ATA" => "22"],
        ];
